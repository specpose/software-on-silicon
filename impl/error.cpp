...
namespace util {
    ...
    void logic_error(error_code what, std::string file_name, std::string function_name, const char* modname)
    {
    ...
    void runtime_error(error_code what, std::string file_name, std::string function_name, const char* modname)
    {
        if (error == error_code::noerror)
            error = what;
        if (!modname)
