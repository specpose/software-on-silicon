...
namespace Protocol {
    ...
    */
        ...
        , bus3()
    {
        ...
        //}
        this->descriptors = { { { static_cast<unsigned char>(0), reinterpret_cast<void*>(&std::get<0>(objects)), sizeof(std::get<0>(objects)), false, false },
        { static_cast<unsigned char>(1), reinterpret_cast<void*>(&std::get<1>(objects)), sizeof(std::get<1>(objects)), false, false },
        { static_cast<unsigned char>(2), reinterpret_cast<void*>(&std::get<2>(objects)), sizeof(std::get<2>(objects)), false, false } },
        s};
