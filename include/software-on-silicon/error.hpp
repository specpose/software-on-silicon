...
//test_ringtomemory.cpp
		...
		const std::string error_message(error_code what){
			switch (what){
				...
				case error_code::MemorycontrollerCorrupted : return std::string("MemoryController corrupted");
				case error_code::NoReadbufferSupplied : return std::string("No ReadBuffer supplied");
				case error_code::SuppliedVstBufferNotInitialised : return std::string("Supplied VST buffer not initialised");
				case error_code::SuppliedVstBufferChannelsNotInitialised : return std::string("Supplied VST buffer channels not initialised");
				case error_code::ContiguousInitializedIncorrectly : return std::string("Contiguous initialized incorrectly");
				case error_code::AssignmentOperatorUsedIncorrectly : return std::string("operator=() used incorrectly");
				case error_code::ExecoperatorcallHasNotFinished : return std::string("operator()() call has not finished");
				case error_code::SuppliedAraBufferNotInitialised : return std::string("Supplied ARA buffer not initialised");
				case error_code::SuppliedAraBufferChannelsNotInitialised : return std::string("Supplied ARA buffer channels not initialised");
				case error_code::FifoReadcallAlreadyInProgress : return std::string("FIFO read call already in progress");
				case error_code::MemorycontrollerResizeError: return std::string("Memorycontroller resize error");
				case error_code::WriterTriedToWriteBeyondMemorycontrollerBounds: return std::string("Writer tried to write beyond memorycontroller bounds");
				case error_code::IllegalReadbufferSizeEncountered: return std::string("Illegal ReadBuffer size encountered");
				case error_code::ArachannelInitializationError: return std::string("ARAChannel initialization error");
				case error_code::MemorycontrollerHasNotBeenInitialized: return std::string("memorycontroller has not been initialized");
				case error_code::IllegalCharactersizeEncountered: return std::string("Illegal character size encountered");
			}
