...
void record_blink_poll(RING_BUFFER::value_type &audio_data, snd_pcm_t *handle, std::size_t& frames_read, pollfd* ufds, unsigned int fd_count, snd_pcm_uframes_t& max) {
